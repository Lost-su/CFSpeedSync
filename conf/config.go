...
type Config struct {
	...
	DnsNum      int    `toml:"dns_num"`      // 同步DNS记录数量
...
func ApplyConfig(config *Config) {
	...
	ddns.CloudflareKVConfig.Domain = config.Cfkv.Domain
	ddns.CloudflareKVConfig.Subdomain = config.Cfkv.Subdomain
